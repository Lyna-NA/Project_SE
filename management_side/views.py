...
def manager_dashboard(request):
    ...
    manager_num=Manager.objects.all().count()
    context={'customers_num':customers_num,'books_num':books_num,'nonReturned_books_num':nonReturned_books_num,'manager_num':manager_num}
